...
async def greet(message: types.Message):
    ...
    # Сбросим возможные старые данные пользователя
    ...
    try:
        ...
        await message.answer_photo(
            photo,
            caption="<b>Добро пожаловать в BalticBike!</b>\n\n🌊 Перед началом обязательно ознакомьтесь с правилами проката."
        )
    except:
        await message.answer(
            "<b>Добро пожаловать в BalticBike!</b>\n\n🌊 Перед началом обязательно ознакомьтесь с правилами проката."
        )

    await message.answer(
        "📋 <b>Правила безопасности и пользования:</b>\n"
        "- Проверьте велосипед перед поездкой\n"
        "- Соблюдайте ПДД и берегите велосипед\n"
        "- Возвращайте в назначенное время\n\n"
        "Нажмите кнопку ниже, чтобы начать аренду.",

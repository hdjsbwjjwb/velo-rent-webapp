...
async def place_1(message: types.Message):
    # Здесь можно добавить описание, фото, или любую другую информацию о месте 1
    await message.answer(
        "📍 Место 1: Природный парк Куршская коса.\n\n"
...
async def place_2(message: types.Message):
    await message.answer(
        "📍 Место 2: Маяк на Балтийской косе.\n\n"
...
async def place_1(message: types.Message):
    # Здесь можно добавить описание, фото, или любую другую информацию о месте 1
    await message.answer(
        "📍 Место 4: Природный парк Куршская коса.\n\n"
        "Уникальное природное место с песчаными дюнами и лесами, идеальное для прогулок на велосипеде."
    )
...
async def place_2(message: types.Message):
    await message.answer(
        "📍 Место 5: Маяк на Балтийской косе.\n\n"
        "Знаменитый маяк с потрясающим видом на море. Отличное место для отдыха и фотосессий."
    )
...
async def place_1(message: types.Message):
    # Здесь можно добавить описание, фото, или любую другую информацию о месте 1
    await message.answer(
        "📍 Место 7: Природный парк Куршская коса.\n\n"
        "Уникальное природное место с песчаными дюнами и лесами, идеальное для прогулок на велосипеде."
    )
...
async def place_2(message: types.Message):
    await message.answer(
        "📍 Место 8: Маяк на Балтийской косе.\n\n"
        "Знаменитый маяк с потрясающим видом на море. Отличное место для отдыха и фотосессий."
    )
